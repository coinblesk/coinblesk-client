                            ...
                            public void onTaskComplete(SignedTxTransferObject response) {
                                ...
                                try {
                                    if (response.isSuccessful()) {
                                        ...
                                        responseMsg = PaymentProtocol.fullTransaction(fullySignedTx, 3333).toBytes(keyPair.getPrivate());
                                    ...
                                    public void onDecision(boolean accepted) {
                                        try {
                                            if (accepted) {
                                                ...
                                                byte[] response = PaymentProtocol.paymentRequestResponse(keyPair.getPublic(), username, new byte[6], halfSignedTx, 3333).toBytes(keyPair.getPrivate());
