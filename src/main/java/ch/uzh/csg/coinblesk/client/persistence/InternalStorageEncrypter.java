...
public class InternalStorageEncrypter {
     ...
     *
     * @param toEncrypt      the plain text to be encrypted
     * @param password the password to be used for encryption
     * @return the cipher text
     * @throws Exception if the encryption was not successful
     */
    protected String encrypt(String toEncrypt, String password) throws Exception {
        byte[] salt = generateSalt();
        return encrypt(toEncrypt, getKey(salt, password), salt);
    }
    ...
    protected String decrypt(String ciphertext, String password) throws WrongPasswordException, Exception {
     ...
     * @param password        the password to be used for the decryption
     * @param rootElementName the root element of the xml file (used as validation if the
     *                        decryption was successful and therefore the provided password
     *                        was valid)
     * @return the plain text
     * @throws WrongPasswordException   if the provided password does not match
     * @throws CorruptFileException     if the stored file is corrupt and cannot be decrypted
    ...
    protected String decrypt(String ciphertext, String password, String rootElementName) throws WrongPasswordException, Exception {
        try {
            String xml = decrypt(ciphertext, password);
