 ...
 */
public class RegistrationActivity extends WalletActivity {
	...
	private void launchCreateRequest() {
		...
		RequestTask<UserAccountObject, ServerWatchingKeyTransferObject> signUp = new SignUpRequestTask(new IAsyncTaskCompleteListener<ServerWatchingKeyTransferObject>() {
			@Override
			public void onTaskComplete(ServerWatchingKeyTransferObject response) {
		...
		}, user, new ServerWatchingKeyTransferObject(), getApplicationContext());
